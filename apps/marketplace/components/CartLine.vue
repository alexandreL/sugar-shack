...
<template>
  <li class="shadow sm:rounded-md sm:overflow-hidden">
    <div class="px-4 py-4 sm:px-6 flex items-center space-x-6">
      <div class="flex-shrink-0">
        <img class="w-8 h-8" :src="orderLine.productImage" alt="">
      </div>
